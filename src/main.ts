...
function initApp(): void {
  ...
  const ui = new EditorUI(editor, renderer, {
    ...
    inputHexWidth: document.getElementById("input-hex-width") as HTMLInputElement | null,
    inputHexWidthVal: document.getElementById("input-hex-width-val") as HTMLInputElement | null,
    btnHexModeRegular: document.getElementById("btn-hex-mode-regular") as HTMLButtonElement | null,
    btnHexModeFlattened: document.getElementById("btn-hex-mode-flattened") as HTMLButtonElement | null,
